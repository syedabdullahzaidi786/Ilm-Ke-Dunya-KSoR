...
const config = {
  ...
  // Static export: `npm run build` writes the whole site into out/, servable
  ...
  //   KSOR_BASE_PATH="/my-repo" npm run build
  ...
  // adopter's `npm run dev` made their own `npm run check` go red — reproduced by the
